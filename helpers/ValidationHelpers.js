...
const EMAIL_REGEXP = /^[\w\d!#$%&'*+/=?^_`}{~-]+(?:\.[\w\d!#$%&'*+/=?^_`}{~-]+)*@(?:[\w\d](?:[\w\d-]*[\w\d])?\.)+[\w\d](?:[\w\d-]*[\w\d])$/;
// eslint-disable-next-line max-len
const EMAILS_REGEXP = /^[\W]*([\w\d!#$%&'*+/=?^_`}{~-]+(?:\.[\w\d!#$%&'*+/=?^_`}{~-]+)*@(?:[\w\d](?:[\w\d-]*[\w\d])?\.)+[\w\d](?:[\w\d-]*[\w\d])[\W]*[,;]{1}[\W]*)*([\w\d!#$%&'*+/=?^_`}{~-]+(?:\.[\w\d!#$%&'*+/=?^_`}{~-]+)*@(?:[\w\d](?:[\w\d-]*[\w\d])?\.)+[\w\d](?:[\w\d-]*[\w\d]))[\W]*$/;
