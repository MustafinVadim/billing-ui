...
/*
Старые регеэкспы. На всякий случай
...
const EMAIL_REGEXP = /^([_a-z0-9-]+(\.[_a-z0-9-]+)*|[_а-яё0-9-]+(\.[_а-яё0-9-]+)*)@([a-z0-9-]+(\.[a-z0-9-]+)*|[а-яё0-9-]+(\.[а-яё0-9-]+)*)(\.([a-z]{2,15}|[а-яё]{2,15}))$/i;

// eslint-disable-next-line max-len
const EMAILS_REGEXP = /^[\W]*(([_a-z0-9-]+(\.[_a-z0-9-]+)*|[_а-яё0-9-]+(\.[_а-яё0-9-]+)*)@([a-z0-9-]+(\.[a-z0-9-]+)*|[а-яё0-9-]+(\.[а-яё0-9-]+)*)(\.([a-z]{2,15}|[а-яё]{2,15}))[\W]*[,;]{1}[\W]*)*(([_a-z0-9-]+(\.[_a-z0-9-]+)*|[_а-яё0-9-]+(\.[_а-яё0-9-]+)*)@([a-z0-9-]+(\.[a-z0-9-]+)*|[а-яё0-9-]+(\.[а-яё0-9-]+)*)(\.([a-z]{2,15}|[а-яё]{2,15})))[\W]*$/i;
